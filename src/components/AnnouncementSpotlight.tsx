...
export default function AnnouncementSpotlight() {
  ...
  return (
    <aside className="card relative h-full w-full overflow-hidden bg-gradient-to-br from-[#2a1a11]/95 via-[#3b2416]/90 to-[#4b2e1c]/85 text-[#f6e8d2] shadow-[0_0_35px_rgba(58,36,22,0.45)]">
